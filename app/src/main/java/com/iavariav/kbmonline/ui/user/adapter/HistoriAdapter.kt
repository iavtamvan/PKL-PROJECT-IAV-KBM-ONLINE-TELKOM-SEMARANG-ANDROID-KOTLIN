...
class HistoriAdapter(private val context: FragmentActivity?, private val PemesananModels: ArrayList<PemesananModel>) : RecyclerView.Adapter<HistoriAdapter.ViewHolder>() {
